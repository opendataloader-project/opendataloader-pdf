...
class ModeWeightStatisticsTest {
    ...
    void getModeReturnsMostFrequentScoreWithinRange() {
        ModeWeightStatistics statistics = new ModeWeightStatistics();
        ...
        double mode = statistics.getMode(9.0, 13.0);
    ...
    void getBoostGivesFractionalRankForScoresAboveMode() {
        ...
        double boostForFourteen = statistics.getBoost(14.0, 32.0, 9.0, 13.0);
        double boostForSixteen = statistics.getBoost(16.0, 32.0, 9.0, 13.0);
        double boostForMode = statistics.getBoost(12.0, 32.0, 9.0, 13.0);
