...
| LiteParse                   | 0.19           | #3   | No table/heading extraction    |
| OpenDataLoader [hybrid]     | 0.46           | #4   | Best accuracy, moderate speed  |
| Docling                     | 0.73           | #5   | 14x slower than OpenDataLoader |
| MinerU                      | 5.96           | #6   | GPU recommended                |
| Marker                      | 53.93          | #7   | GPU required for practical use |
