...
| `--content-safety-off`      | -     | `string`  | -            | Disable content safety filters. Values: all, hidden-text, off-page, tiny, hidden-ocg, sensitive-data                               |
...
| `--min-pages-parallel`      | -     | `string`  | `"8"`        | Minimum page count to enable parallel page processing within a document. Default: 8                                                |
