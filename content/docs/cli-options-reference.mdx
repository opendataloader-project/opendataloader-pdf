...
### Multiple files (single JVM invocation)

```bash
opendataloader-pdf report.pdf contract.pdf invoice.pdf -o ./output -f json,markdown
```
...
```bash
opendataloader-pdf report.pdf ./invoices/ ./receipts/ -o ./output -f markdown
```
