...
def convert(
    ...
    Args:
        ...
        content_safety_off: Disable content safety filters. Values: all, hidden-text, off-page, tiny, hidden-ocg, sensitive-data. Note: sensitive-data may replace emails/URLs with placeholders unless disabled.
