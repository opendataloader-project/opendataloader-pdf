...
CLI_OPTIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "required": False,
        "default": None,
        "description": "Output formats (comma-separated). Values: json, text, html, pdf, markdown, markdown-with-html, markdown-with-images, tagged-pdf, graph-json. Default: json",
    },
    {
        "name": "quiet",
        "python_name": "quiet",
