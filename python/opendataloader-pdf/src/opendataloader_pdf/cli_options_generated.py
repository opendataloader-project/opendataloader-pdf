...
CLI_OPTIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "required": False,
        "default": "20",
        "description": "Pages per layout request. Requires --hybrid=hancom-ai. The backend accepts at most 30 pages per request, so longer documents are sliced; 0 disables slicing and sends every page in one request. Default: 20",
    },
    {
        "name": "to-stdout",
