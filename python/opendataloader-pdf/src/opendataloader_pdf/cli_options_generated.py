...
CLI_OPTIONS: List[Dict[str, Any]] = [
    ...
    {
        "name": "hybrid-hancom-ai-layout-page-chunk",
        "python_name": "hybrid_hancom_ai_layout_page_chunk",
        "short_name": None,
        "type": "string",
        "required": False,
        "default": "20",
        "description": "Pages per layout request. Requires --hybrid=hancom-ai. The backend rejects requests past roughly 30 pages, so longer documents are sliced; 0 disables slicing and sends every page in one request. Default: 20",
    },
    {
        "name": "to-stdout",
