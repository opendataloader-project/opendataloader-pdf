...
- **如何把它用于 RAG？** — `pip install opendataloader-pdf`，用 3 行代码就可以完成转换。输出适合文本切块（chunking）的结构化 Markdown、带边界框的 JSON（用于引用来源），以及 HTML。支持 LangChain 集成。支持 Python、Node.js、Java SDK（[快速开始](#30-秒内快速开始) | [LangChain](#langchain-集成)）
