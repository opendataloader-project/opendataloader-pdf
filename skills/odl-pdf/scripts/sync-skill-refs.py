...
Compares the option names in the repository's exported options.json snapshot
against the option names documented in skills/odl-pdf/references/options-matrix.md.

Any mismatch means the skill reference is out of sync with the repository option snapshot —
